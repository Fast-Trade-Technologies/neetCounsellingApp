...
import 'package:neetcounsellingapp/app/modules/tools/fees_seat_matrix/fees_seat_matrix_controller.dart';
        ...
        return SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10.h),
              Row(children: [Expanded(child: _FilterDropdown(label: 'Quota', value: controller.selectedQuota.value, items: controller.quotasForDropdown, onChanged: controller.setQuota)), SizedBox(width: 10.w), Expanded(child: _FilterDropdown(label: 'Category', value: controller.selectedCategory.value, items: controller.categoriesForDropdown, onChanged: controller.setCategory))]),
              SizedBox(height: 10.h),
          ...
          children: [
            ...
            Obx(() {
              ...
              return PaginationBar(
                ...
                entriesOptions: FeesSeatMatrixController.entriesOptions,
            ...
            Obx(() {
              ...
              return PlanLockedSection(
                ...
                unlockedCount: 4,
                itemSpacing: 16.h,
                itemBuilder: (context, i) => _FeesSeatCard(
                  row: list[i],
...
class _FeesSeatCard extends StatelessWidget {
  const _FeesSeatCard({required this.row, required this.serialNumber});
