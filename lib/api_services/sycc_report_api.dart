...
class SyccReportApi {
  static const String syccReportPath = '/sycc-report';

  static final BaseAPI _api = BaseAPI();

  /// GET {{base_url}}/sycc-report with nLoginUserIdNo as query param.
  static Future<(bool success, Map<String, dynamic>? data, String? errorMessage)> getSyccReport({
    bool showLoader = true,
    Map<String, dynamic>? extraQuery,
  }) async {
    final userId = AppStorage.userId;
    if (userId == null || userId.isEmpty) {
      return (false, null, 'Please sign in to load SYCC report');
    }
    try {
      ...
      if (response.statusCode != 200) {
        ...
        return (false, null, msg ?? 'Failed to load SYCC report');
      }
      ...
      return (false, null, message ?? 'Failed to load SYCC report');
